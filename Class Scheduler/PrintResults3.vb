...
Public Class PrintResults3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Class_Scheduler.PrintResults3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrintResults3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintResults3 = New PrintResults3()
        rpt.Site = Me.Site
        Return rpt
    End Function
