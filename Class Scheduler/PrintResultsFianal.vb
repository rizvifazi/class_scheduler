...
Public Class PrintResultsFianal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Class_Scheduler.PrintResultsFianal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrintResultsFianal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintResultsFianal = New PrintResultsFianal()
        rpt.Site = Me.Site
        Return rpt
    End Function
