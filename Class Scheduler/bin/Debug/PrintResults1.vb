...
Public Class PrintResults1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Class_Scheduler.PrintResults1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrintResults1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintResults1 = New PrintResults1()
        rpt.Site = Me.Site
        Return rpt
    End Function
